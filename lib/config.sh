...
_CONFIG_SIMPLE_MAPPINGS=(
    ...
    ".watcher.initial_delay:CONFIG_WATCHER_INITIAL_DELAY"
    ".watcher.cleanup_delay:CONFIG_WATCHER_CLEANUP_DELAY"
    ".watcher.cleanup_retry_interval:CONFIG_WATCHER_CLEANUP_RETRY_INTERVAL"
    ".watcher.pr_merge_max_attempts:CONFIG_WATCHER_PR_MERGE_MAX_ATTEMPTS"
    ".watcher.pr_merge_retry_interval:CONFIG_WATCHER_PR_MERGE_RETRY_INTERVAL"
)
...
_ENV_OVERRIDE_MAP=(
    ...
    "WATCHER_INITIAL_DELAY:CONFIG_WATCHER_INITIAL_DELAY"
    "WATCHER_CLEANUP_DELAY:CONFIG_WATCHER_CLEANUP_DELAY"
    "WATCHER_CLEANUP_RETRY_INTERVAL:CONFIG_WATCHER_CLEANUP_RETRY_INTERVAL"
    "WATCHER_PR_MERGE_MAX_ATTEMPTS:CONFIG_WATCHER_PR_MERGE_MAX_ATTEMPTS"
    "WATCHER_PR_MERGE_RETRY_INTERVAL:CONFIG_WATCHER_PR_MERGE_RETRY_INTERVAL"
)
